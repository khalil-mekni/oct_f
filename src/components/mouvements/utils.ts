...
import type { Emballage } from "@/types/mouvement";
...
export const TYPES: {
  ...
  },
  {
    value: "SPL",
    label: "SPL (Surplus)",
    hint: "Ajoute stock + nouveau lot",
    color: "text-emerald-600 bg-emerald-50",
  },
];

export const needsSource = (t: MouvementType) =>
  ["PRD", "CDD", "PTE"].includes(t);

export const needsDestination = (t: MouvementType) =>
  ["ENT", "CDD", "SPL"].includes(t);

export const needsLot = (t: MouvementType) =>
  !["ENT", "SPL"].includes(t);
