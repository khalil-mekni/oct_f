...
import { Receipt, ShoppingCart, Truck, Boxes, ArrowLeftRight } from "lucide-react";
...
const AppSidebar: React.FC = () => {
  ...
  return (
    ...
    >
      <div
        className={`py-10 flex items-center transition-all duration-300 ${!isExpanded && !isHovered ? "justify-center" : "justify-start px-6"
          }`}
      >
